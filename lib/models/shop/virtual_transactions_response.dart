import 'package:llegaexpress/models/shop/virtual_transaction.dart';
...
class VirtualTransactionsResponse {
  ...
  VirtualTransactionsResponse.fromJson(Map<String, dynamic> json) {
    ...
    this.transacciones = json["Transacciones"] == null
        ? null
        : (json["Transacciones"] as List)
            .map((e) => VirtualTransaction.fromJson(e))
            .toList();
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.transacciones != null)
      data["Transacciones"] =
          this.transacciones?.map((e) => e.toJson()).toList();
    return data;
  }
}

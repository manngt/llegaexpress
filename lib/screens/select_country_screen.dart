...
class _SelectCountryScreenState extends State<SelectCountryScreen> {
  _saveCountryScope(String merchantScope, String tokenScope,
      String baseUrlScope, String countryScope) async {
  ...
  _setCountryScope(String countrySelected) async {
    if (countrySelected == 'GT') {
      await _saveCountryScope(
          'GT_MERCHANT_ID', 'GT_MERCHANT_TOKEN', 'GT_BASE_URL', 'GT');
    }
    if (countrySelected == 'US') {
      await _saveCountryScope(
          'US_MERCHANT_ID', 'US_MERCHANT_TOKEN', 'US_BASE_URL', 'US');
    }
  }
            ...
            Positioned(
              child: Column(
                children: [
                  SizedBox(
                    child:
                        Image.asset('images/llega_logo_blanco_1024x1024.png'),
                    height: 200,
                    width: 175,
                  ),
                  Container(

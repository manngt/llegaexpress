...
import 'package:llegaexpress/models/shop/qr_pay_response.dart';
import 'package:llegaexpress/services/purchase_service.dart';
import 'package:llegaexpress/services/qr_scanner.dart';
...
class _QrShopFormState extends State<QrShopForm> with WidgetsBindingObserver {
  ...
  //function to Scan QR, size: from 0 to 36, Merchant: 15-17, Employee: 34-36
